...
class Header extends Component {
    ...
    componentDidMount() {
        fetch("/auth/login/success", {
            ...
            .then(responseJson => {
                this.context.authenticatedReducer.authenticatedTestAction(responseJson.success, responseJson.user, responseJson.error)
            })
            .catch(error => {
                this.context.authenticatedReducer.authenticatedTestAction(false, false, error.message)
